...
4. If `.opencode/package.json` already exists, make sure `@opencode-ai/plugin` is listed as a dependency (version `1.18.3` or later). If it doesn't exist, create it with `{ "dependencies": { "@opencode-ai/plugin": "1.18.3" } }`.
